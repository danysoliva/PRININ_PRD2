...
//namespace POS_Gasolinera_v1._0
//{
//    class ConversorNumALetras
//    {
//    }
//}
...
namespace POS_Gasolinera_v1._0
{
    public class ConversorNumALetrasDolares
    {
        ...
        public ConversorNumALetrasDolares(decimal dMonto)
        {
            if (dMonto == 0)
            {
                NumeroEnLetras = "CERO DOLARES";
            }
            else
            {
                ...
                NumeroEnLetras = (Num2Text(Convert.ToInt64(Decimal.Truncate(Convert.ToDecimal(dMonto))))) + " DOLARES CON " + Convert.ToInt32(decimales) + "/100 CTVS.";
